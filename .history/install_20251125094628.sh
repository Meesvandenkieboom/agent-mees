...
# =============================================================================
# Agent Mees Installer - Production Grade
# =============================================================================
...
# Configuration
REPO="YOUR_GITHUB_USERNAME/agent-mees"
APP_NAME="agent-mees"
...
download_release() {
  log_section "Downloading Agent Mees $VERSION"
...
validate_and_rebuild_dependencies() {
  ...
  if ! command -v node &> /dev/null; then
    ...
    echo ""
    echo "Agent Mees requires Node.js v18+ for the Claude SDK subprocess."
    echo ""
  ...
  if [[ "$NODE_PATH" == *"/mnt/c/"* ]] || [[ "$NODE_PATH" == *.exe ]]; then
    ...
    echo ""
    echo "You have Windows Node.js in your PATH, but Agent Mees needs native WSL Node."
    echo ""
...
show_success_message() {
  ...
  echo -e "${GREEN}Agent Mees $VERSION has been installed successfully!${NC}"
  echo ""
